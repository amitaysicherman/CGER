...
"python train.py --pooling 1 --bottleneck_dim 128 --size 'm' --dropout 0.0 --epochs 100 --cold_fasta 1 --gen_mol 1 --train_encoder 1"
"python train.py --pooling 1 --bottleneck_dim 128 --size 'm' --dropout 0.0 --epochs 100 --cold_smiles 1 --train_encoder 1"
"python train.py --pooling 1 --bottleneck_dim 128 --size 'm' --dropout 0.0 --epochs 100 --gen_mol 1 --train_encoder 1"
"python train.py --pooling 1 --bottleneck_dim 128 --size 'm' --dropout 0.0 --epochs 100 --train_encoder 1"
